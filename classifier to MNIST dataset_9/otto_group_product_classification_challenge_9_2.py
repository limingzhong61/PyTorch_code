...
train_data_fname = './otto-group-product-classification-challenge\\train.csv'
test_data_fname = './otto-group-product-classification-challenge\\test.csv'
...
# target  是 train.csv数据集中预测结果label标签，即y^hat
train_labels = torch.tensor(
    train_data["target"].values.reshape(-1, 1), dtype=torch.float32)
